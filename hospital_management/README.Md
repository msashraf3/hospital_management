...
- [ ] Field-level restrictions on Appointment form (Doctors can edit patient/doctor/date directly, not just via buttons)
- [ ] Record Rules (Doctors should only see their own patients/appointments, not everyone's)
